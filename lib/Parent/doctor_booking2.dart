...
class DoctorBooking2 extends StatefulWidget {
  const DoctorBooking2({super.key});

  @override
  State<DoctorBooking2> createState() => _DoctorBooking2State();
}

class _DoctorBooking2State extends State<DoctorBooking2> {
  @override
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              Column(
                                children: [
                                  Image.asset("assets/doctor2.png", height: 100,
                                    width: 150,),
                              ...
                              Column(
                                  ...
                                  children: [
                                    Text("Dr.Antony", style: TextStyle(
                                      fontSize: 25,
                                      fontWeight: FontWeight.bold,
                                      color: Colors.black,
                                    ),),
